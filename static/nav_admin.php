<nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark static-top">
  ...
  </button> <a class="navbar-brand" href="index.php">Rainbow6Bets</a>
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="index.php">Incontri disponibili</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#">Gestisci Utenti</a>
          <a class="dropdown-item" href="#">Gestisci Team</a>
          <a class="dropdown-item" href="#">Gestisci Leghe</a>
          <div class="dropdown-divider">
          </div> <a class="dropdown-item" href="#">Impostazioni</a>
        </div>
      </li>
    </ul>
